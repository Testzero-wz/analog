...
from analog.thirdparty.terminaltables.ascii_table import AsciiTable
from analog.thirdparty.terminaltables.terminal_io import IS_WINDOWS
...
class AnalogTable(LogTable if IS_WINDOWS else UnixTable):
    pass
